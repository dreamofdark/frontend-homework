...
QUnit.module('Тестируем функцию sorting', function () {
	...
	QUnit.test('sorting не сортирует массив, если у какого-либо объекта не хватает свойства', function (assert) {
		const initial = [
			{prop1: 3, id: '1'},
			{prop1: 3, id: '2'},
			{prop1: 1},
	...
	QUnit.test('sorting сортирует массив с повторяющимися свойствами', function (assert) {
		const initial = [
			{prop1: 30},
			{prop1: 1000},
			{prop1: 4},
		...
		const actual = sorting(initial, [ 'prop1', 'prop1' ]);
